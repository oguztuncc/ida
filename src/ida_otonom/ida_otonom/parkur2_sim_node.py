...
class Parkur2SimNode(Node):
    def __init__(self) -> None:
        ...
        self.scan_ray_count = max(31, int(self.get_parameter("scan_ray_count").value))
        ...
        self.get_logger().info(
            f"Parkur-2 sim world loaded with {len(self.objects)} object(s)"
        )
    ...
    def publish_scan(self) -> None:
        ...
        scan.scan_time = 1.0 / max(float(self.get_parameter("scan_rate_hz").value), 1.0)
    ...
    def publish_detections(self) -> None:
        ...
        for obj in self.objects:
            ...
            center_x = image_w / 2.0 + (bearing_deg / self.detection_fov_deg) * image_w
            ...
            detections.append(
                {
                    ...
                    "confidence": 0.88 if obj.kind == "course_boundary" else 0.82,
                    "bbox_xyxy": [
                        center_x - box_w / 2.0,
                ...
                data=to_json(
                    {
                        ...
                        "frame_id": "sim_camera",
                        "model_path": "synthetic_parkur2_sim",
                        "model_loaded": True,
