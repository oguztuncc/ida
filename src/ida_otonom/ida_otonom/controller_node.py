...
class ControllerNode(Node):
    def __init__(self) -> None:
        ...
        self.setpoint_pub = self.create_publisher(String, "/control/setpoints", 10)
        ...
        self.create_subscription(String, "/perception/corridor_hint", self.corridor_hint_cb, 10)
    ...
    def loop(self) -> None:
        ...
        heading_error = normalize_angle_deg(corrected_target - self.current_heading)
